...
<head>
    ...
    <link rel="stylesheet"
        href="{{ asset('assets/base/template') }}/vendors/simple-line-icons/css/simple-line-icons.css">
    <link rel="stylesheet" href="{{ asset('assets/base/template') }}/vendors/css/vendor.bundle.base.css">
    <!-- endinject -->
    <!-- Plugin css for this page -->
    <link rel="stylesheet"
        href="{{ asset('assets/base/template') }}/vendors/datatables.net-bs4/dataTables.bootstrap4.css">
    ...
    <link rel="shortcut icon"
        href="{{ asset('assets/base/template') }}/{{ asset('assets/base/template') }}/images/favicon.png" />
    <style>
                ...
                <ul class="navbar-nav">
                    <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
                        <h1 class="welcome-text"> <span class="text-black fw-bold"
                                style="color: rgb(46, 178, 26);">APLIKASI SDIDTK</span></h1>
                        <h3 class="welcome-sub-text">Stimulasi, Deteksi dan Intervensi Dini Tumbuh Kembang Anak </h3>
                    </li>
                </ul>
