...
@section('main-header', 'Data Pelaksana')
                        ...
                        <tbody>
                            @foreach ($data as $item)
                                <tr>
                                    ...
                                    <td>{{ strtoupper($item->login_level) }}</td>
                                        ...
                                        <div class="modal fade" id="modaldelete{{ $item->id }}" tabindex="1"
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="{{ route('hapus-pelaksana', $item->id) }}" method="POST"
        ...
        {{-- <form action="{{ route('post-pilih-peserta') }}" method="POST">
            ...
            <div class="row">
                <div class="col-sm-8 col-md-8 col-lg-8">
                    <div class="form-group">
                        <label for="exampleSelectGender">Data Pelaksana pelayanan : </label>
                        <select class="form-control" id="exampleSelectGender" name="id_peserta">
                            <option selected>Data Pelaksana...</option>
                            @foreach ($data as $item)
